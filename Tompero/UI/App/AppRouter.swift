...
enum AppDestination: Hashable {
    ...
    case statistics(MatchStatistics, localActions: PlayerAwardStats, peerAwards: [String: PlayerAwardStats])
    ...
    static func == (lhs: AppDestination, rhs: AppDestination) -> Bool {
        ...
        case (.statistics(let a, let aActions, let aPeers), .statistics(let b, let bActions, let bPeers)):
            return a === b && aActions == bActions && aPeers == bPeers
        default:
            return false
        }
    }
